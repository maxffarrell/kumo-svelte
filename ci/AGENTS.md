...
├── scripts/
│   ├── validate-kumo-svelte-changeset.ts # Pre-push + CI changeset enforcement
...
| Task                 | Location                                     | Notes                                                   |
| -------------------- | -------------------------------------------- | ------------------------------------------------------- |
| Changeset validation | `scripts/validate-kumo-svelte-changeset.ts`  | Used by lefthook pre-push AND CI                        |
...
- **Composite action**: `.github/actions/install-dependencies/action.yml` installs pnpm 11.1.1, Node 26, with optional filter
