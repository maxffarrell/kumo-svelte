  ...
  describe("variant fidelity", () => {
    ...
    it("applies link styling on breadcrumb links", () => {
      ...
      const link = screen
        ...
        .find((candidate) => candidate.className.includes("text-kumo-subtle"));
    ...
    it("renders separator with inactive color", () => {
      ...
      expect(separator?.closest("span")?.className).toContain(
        "text-kumo-inactive",
      );
    });
    ...
    it("includes mobile breadcrumb key classes for collapsed trails", () => {
      ...
      expect(
        container.querySelector(".kumo-breadcrumb-mobile-ellipsis"),
      ).toBeTruthy();
      expect(
        container.querySelector(".kumo-breadcrumb-mobile-separator-leading"),
      ).toBeTruthy();
      expect(
        container.querySelector(".kumo-breadcrumb-mobile-parent"),
      ).toBeTruthy();
      expect(
        container.querySelector(".kumo-breadcrumb-mobile-current"),
      ).toBeTruthy();
    });
  });
